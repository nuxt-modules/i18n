...
<template>
  <div>
    ...
    >{{ $t('blog') }}</NuxtLink>
    <NuxtLink
      id="link-ignore-disable"
      :to="localePath('/ignore-routes/disable')"
    >go to ignoring localized disable route</NuxtLink>
    <NuxtLink
      id="link-ignore-pick"
      :to="localePath('/ignore-routes/pick')"
    >go to ignoring localized pick route</NuxtLink>
    <NuxtLink
      id="link-category"
      :to="localePath('/category/test')"
    >go to category test</NuxtLink>
    <NuxtLink
      id="link-products"
      :to="localePath({ name: 'products-id', params: { id: 'foo' } })"
    >
      go to product foo
    </NuxtLink>
    <NuxtLink
    ...
    <NuxtLink
      id="link-define-i18n-route-false"
      exact
      :to="localePath('/define-i18n-route-false')"
    ...
    <NuxtLink
      id="issue-3831-nested-root"
      :to="localePath('index-nested-root-page')"
    >Nested index page</NuxtLink>
  </div>
</template>
