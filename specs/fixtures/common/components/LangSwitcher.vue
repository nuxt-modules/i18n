...
<template>
  <div>
    <section
      v-if="!$nuxt.$config.public.i18n.experimental.strictSeo"
      id="lang-switcher-with-nuxt-link"
    >
    ...
    <section id="lang-switcher-current-locale">
      <strong>Current Locale: <code>{{ locale }}</code></strong>:
    </section>
    <section id="lang-switcher-default-locale">
      <strong>Default Locale: <code>{{ defaultLocale }}</code></strong>:
    </section>
    <section>
