...
import type { Directions, LocaleObject, Strategies } from '../types.js';
...
export interface NuxtI18nRoutingCustomProperties<ConfiguredLocaleType extends Locale[] | LocaleObject[] = Locale[] | LocaleObject[]> {
    /**
     * List of locales
     *
     * @remarks
