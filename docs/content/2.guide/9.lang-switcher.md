...
:br :br
For example projects with a lang switcher (with `switchLocalePath`) in the layout and fetching data in a page, setting i18n parameters in the page will result in a hydration mismatch. As the layout and its components have already been rendered and do not update reactively by changes introduced by pages and components further down the tree.
:br :br
...
switchLocalePath('nl') // /products/rode-mok
</script>
