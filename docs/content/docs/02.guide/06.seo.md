...
To leverage the SEO benefits, you must configure the `locales` option as an array of objects, where each object has a `language` option set to the locale language tags:
