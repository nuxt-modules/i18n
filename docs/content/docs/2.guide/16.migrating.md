...
You can continue defining `vueI18n` options in `i18n.config`. Refer to the [Vue i18n](/docs/options/vue-i18n) and [basic usage](/docs/getting-started/basic-usage/#translate-with-vue-i18n) sections for examples on how to do so.
