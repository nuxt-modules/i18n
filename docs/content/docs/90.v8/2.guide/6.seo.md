...
(Note that `baseUrl` can also be set to a function. Check [`baseUrl` documentation](/docs/v8/options/routing#baseurl).)
...
Check out the options you can pass to the `useLocaleHead` in the [API documentation](/docs/v8/api#uselocalehead)
