...
You now have a really simple Vue I18n based translation environment ready to go! Running the above page component in your project, the `<form>` element that contains both English and French options, choosing a language from the dropdown, you can see the word "welcome" change in its corresponding language.
