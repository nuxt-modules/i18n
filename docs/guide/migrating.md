...
You can continue defining `vueI18n` options in `i18n.config`. Refer to the [Vue i18n](/options/vue-i18n) and [basic usage](/getting-started/basic-usage/#translate-with-vue-i18n) sections for examples on how to do so.
...
For more details, see [Lang Switcher](/guide/lang-switcher#dynamic-route-parameters).
...
For more details see [Extending messages hook](/guide/extend-messages).
